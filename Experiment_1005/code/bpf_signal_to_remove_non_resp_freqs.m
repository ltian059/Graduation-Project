function s_filt = bpf_signal_to_remove_non_resp_freqs(s, Fs)
...
s_evlfs = s_win;
s_evlfs.v = elim_vlfs(s_win);

%% LPF to remove freqs above resp
s_filt.t = s_evlfs.t;
s_filt.v = lp_filter_signal_to_remove_freqs_above_resp(s_evlfs.v, s_evlfs.fs);
